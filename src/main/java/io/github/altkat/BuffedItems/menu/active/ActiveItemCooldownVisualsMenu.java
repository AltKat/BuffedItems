...
public class ActiveItemCooldownVisualsMenu extends Menu {

    private final BuffedItems plugin;
    private final String itemId;

    public ActiveItemCooldownVisualsMenu(PlayerMenuUtility playerMenuUtility, BuffedItems plugin) {
    ...
    public String getMenuName() {
        return "Cooldown Visuals: " + itemId;
    }
