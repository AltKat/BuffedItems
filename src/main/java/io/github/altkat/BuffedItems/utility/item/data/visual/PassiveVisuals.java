...
public class PassiveVisuals {
    ...
    public PassiveVisuals(ActionBarSettings actionBar, BossBarSettings bossBar, TitleSettings title, SoundSettings sound, List<ParticleDisplay> particles) {
    ...
    public List<ParticleDisplay> getParticles() { return particles; }
}
